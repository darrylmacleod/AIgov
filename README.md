...
1. Download `AIGov.html`
2. Open it in Chrome, Firefox, Edge, or Safari
3. A sample LLM application diagram loads automatically, including Trust Boundary, PII Processing, and High-Risk AI zones
...
3. Add a **Bias / Fairness Monitor** connected to the model, and an **Audit Log** receiving flows from every decision-making component
4. Ensure every **Automated Decision** component has a **Human-in-the-Loop** component connected with a Human Review flow
5. Document the conformity assessment approach and technical documentation plan in the Narrative
